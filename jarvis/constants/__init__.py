...
from .models import (
    ...
    MAX_PARALLEL_TOOLS, CONTEXT_BUNDLE_MAX_CHARS,
    ...
    MODE_DEFAULT, MODE_CODING, MODE_REVERSE_ENG, MODE_SETUP,
)
...
from .system_prompt import SYSTEM, CODING_ADDON, REVERSE_ENG_ADDON, SETUP_ADDON, build_base_system
