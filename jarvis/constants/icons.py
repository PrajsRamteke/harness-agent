"""Terminal-friendly glyphs per tool category — makes the event log skimmable."""
TOOL_ICONS = {
    "read_file": "≡", "read_document": "≣", "write_file": "✚", "edit_file": "✎", "multi_edit": "✎",
    "list_dir": "▣", "run_bash": "⚡", "search_code": "◎",
    "glob_files": "◇", "rank_files": "◆",
    "resolve_context": "✦", "read_bundle": "▤",
    "git_status": "⬡", "git_diff": "∆",
    "git_log": "∥",
    "launch_app": "▸", "focus_app": "❯", "quit_app": "✕",
    "list_apps": "☰", "frontmost_app": "⌂", "run_powershell": "⌘",
    "read_ui": "▒", "click_element": "↟", "wait": "⟳",
    "check_permissions": "⬟", "type_text": "⌨", "key_press": "⌨",
    "click_menu": "☰", "click_at": "⊕",
    "clipboard_get": "☐", "clipboard_set": "☑",
    "open_url": "⌗", "notify": "⚐", "speck": "♪",
    "shortcut_run": "⚙", "win_control": "⚙",
